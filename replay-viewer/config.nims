...
switch(
  "passL",
  (&"""
  -o {distDir / "hanabi_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=HanabiReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_hb_load_replay,_hb_payload_ptr,_hb_payload_len,_hb_error_ptr,_hb_error_len
  """).replace("\n", " ")
)
